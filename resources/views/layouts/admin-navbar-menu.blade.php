...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Admin | Easy Fix Phone Store | Kenya</title>
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{ asset('e-commerce-assets/vendors/dropzone/dropzone.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('e-commerce-assets/vendors/prism/prism-okaidia.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('e-commerce-assets/css/custom.css') }}" type="text/css" rel="stylesheet">
    <script>
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                        ...
                        <li class="nav-item">
                                        ...
                                        <li class="nav-item"><a class="nav-link dropdown-indicator" href="#admin"
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent show" data-bs-parent="#e-commerce"
                                                    id="admin">
                                                    <li class="nav-item {{ Request::is('admin/dashboard/add-category') ? 'active':'' }}">
                                                        <a class="nav-link" href="{{route('add-category.dashboard')}}"
                                                           data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center"><span
                                                                    class="nav-link-text">Add category</span>
                                                            </div>
                                                        </a>
                                                        <!-- more inner pages-->
                                                    </li>
                                                    <li class="nav-item {{ Request::is('admin/dashboard/add-product')  ? 'active':'' }}">
                                                        <a class="nav-link" href="{{route('add-product.dashboard')}}"
                                                           data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center"><span
                                                    ...
                                                    <li class="nav-item"><a class="nav-link"
                                                                            href="{{route('customers-details.dashboard')}}"
                                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center"><span
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1"
                                                             href="#project-management" role="button"
                        ...
                        <li class="nav-item">
                            ...
                            <div class="nav-item-wrapper"><a class="nav-link label-1"
                                                             href="../../../pages/pages/faq.html" role="button"
                                                             data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                            ...
                            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#pricing"
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                                href="../../../pages/pages/pricing/pricing-column.html"
                                                                data-bs-toggle="" aria-expanded="false">
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                                href="../../../pages/pages/pricing/pricing-grid.html"
                                                                data-bs-toggle="" aria-expanded="false">
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper"><a class="nav-link label-1"
                                                             href="../../../pages/pages/members.html" role="button"
                                                             data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper"><a class="nav-link label-1"
                                                             href="../../../pages/pages/timeline.html" role="button"
                                                             data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                            ...
                            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#errors"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="nav-link-icon"><span
                                                data-feather="alert-triangle"></span></span><span class="nav-link-text">Errors</span>
                                    </div>
                                </a>
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="../../../index.html">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center"><img
                                    src="{{ asset('e-commerce-assets/img/icons/logo.png') }}" alt="phoenix" width="27"/>
                                <p class="logo-text ms-2 d-none d-sm-block">EasyFix</p>
                            </div>
                        </div>
                    </a>
                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="avatar avatar-m status-online me-3"><img
                                                                ...
                                                                src="../../../assets/img/team/30.png" alt=""/>
                                                        </div>
                                ...
                                <div class="scrollbar-overlay" style="max-height: 30rem;">
                                    <div class="list pb-3">
                                        ...
                                        <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="fs--2 mb-0 d-flex text-700"><span
                                                            class="fw-medium text-600">8GB Memory - 1.6GHz - 128GB Storage</span>
                                                    </p>
                                                </div>
                                            </a>
                                            <a class="dropdown-item py-2 d-flex align-items-center"
                                        ...
                                        <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                                             href="../../../pages/pages/members.html">
                                                <div class="avatar avatar-l status-online  me-2 text-900">
                                                    <img class="rounded-circle " src="../../../assets/img/team/10.png"
                                                         alt=""/>
                                            ...
                                            <a class="dropdown-item py-2 d-flex align-items-center"
                                               href="../../../pages/pages/members.html">
                                                <div class="avatar avatar-l  me-2 text-900">
                                                    <img class="rounded-circle " src="../../../assets/img/team/12.png"
                                                         alt=""/>
...
{{--<script src="{{asset('e-commerce-assets/vendors/tinymce/tinymce.min.js')}}"></script>--}}
{{--<script src="{{asset('e-commerce-assets/vendors/dropzone/dropzone.min.js')}}"></script>--}}
{{--<script src="{{asset('e-commerce-assets/vendors/choices/choices.min.js')}}"></script>--}}
{{--<script src="{{asset('e-commerce-assets/vendors/prism/prism.js')}}"></script>--}}
{{--<script src="{{asset('e-commerce-assets/js/phoenix.js')}}"></script>--}}
...
<script src="{{ asset('e-commerce-assets/vendors/prism/prism.js') }}"></script>
<script src="{{ asset('e-commerce-assets/js/phoenix.js') }}"></script>
<script src="{{ asset('e-commerce-assets/vendors/rater-js/index.js>') }}"></script>
...
@push('scripts')
    ...
    <script>
        feather.replace();
        $('.revenue-visibility-icon').on('click', function () {
            $(this).toggleClass('text-primary');
            $('.revenue-amount').toggleClass('text-muted');
        });
    </script>
@endpush
