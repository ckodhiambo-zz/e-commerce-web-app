                ...
                <div class="row g-3 mb-9">
                    <div class="col-12">
                        <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 product-bg"
                                 style="background-image:url({{asset('e-commerce-assets/img/e-commerce/whooping_banner_product.png')}});background-position: bottom right;">
                            </div>
                            <!--/.bg-holder-->

                            <div class="bg-holder z-index--1 shape-bg"
                                 style="background-image:url({{asset('e-commerce-assets/img/e-commerce/whooping_banner_shape_2.png')}});background-position: bottom left;">
                            </div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="gift-items-banner w-100 rounded-3 overflow-hidden">
                            <div class="bg-holder z-index--1 banner-bg"
                                 style="background-image:url({{asset('e-commerce-assets/img/e-commerce/gift-items-banner-bg.png')}});">
                            </div>
                            <!--/.bg-holder-->
                    ...
                    <div class="col-12 col-xl-6">
                        <div
                            ...
                            <div class="bg-holder z-index--1 banner-bg"
                                 style="background-image:url({{asset('e-commerce-assets/img/e-commerce/best-in-market-bg.png')}});">
                            </div>
                            <!--/.bg-holder-->
                            ...
                            <div class="row align-items-center w-sm-100">
                                ...
                                <div class="col-4"><img class="w-100 w-sm-75"
                                                        src="{{asset('e-commerce-assets/img/e-commerce/5.png')}}"
                                                        alt=""></div>
                            </div>
                        </div>
                    </div>
...
{{--                                                           href="{{ route('product-details.dashboard', $product->slug) }}">--}}
...
{{--                                    @endforeach--}}
                    ...
                    {{--                            <div class="bg-holder" style="background-image:url({{asset('e-commerce-assets/img/e-commerce/4.png')}});">--}}
                    {{--                            </div>--}}
                    {{--                            <!--/.bg-holder-->--}}
                    ...
                    {{--                                                                    src="{{asset('e-commerce-assets/img/products/6.png')}}" alt=""/></a>--}}
                    {{--                    </div>--}}
                </div>
                ...
                <div class="mb-6">
                    <div class="d-flex flex-between-center mb-3">
                        <h3>All Categories</h3><a class="fw-bold d-none d-md-block" href="#!">Explore more<span
                                class="fas fa-chevron-right fs--1 ms-1"></span></a>
                    </div>
                    <div class="swiper-theme-container products-slider">
                        <div class="swiper swiper-container theme-slider"
                            ...
                            <div class="swiper-wrapper">
                                @foreach($categories as $category)
                                    <div class="swiper-slide">
                                        <a href="{{url('category/'.$category->slug)}}" class="stretched-link text-decoration-none">
                                            <div class="position-relative text-decoration-none product-card h-100">
                                                <div class="d-flex flex-column justify-content-between h-100">
                                                    <div>
                                                        <div class="border border-1 rounded-3 position-relative mb-3">
                                                            <img class="img-fluid"
                                                                 src="{{asset('e-commerce-assets/img/products/5.png')}}"
                                                                 alt=""/>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <h3 class="text-1100">{{ $category->name }}</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                            ...
                                            <div>
                                                ...
                                                <a class="stretched-link text-decoration-none"
                                                   href="../../../apps/e-commerce/landing/product-details.html">
                                                    <h6 class="mb-2 lh-sm line-clamp-3">RESPAWN 200 Racing Style Gaming
                                    ...
                                    <div class="position-relative text-decoration-none product-card h-100">
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <a class="stretched-link text-decoration-none"
                                                   href="../../../apps/e-commerce/landing/product-details.html">
                                                    <h6 class="mb-2 lh-sm line-clamp-3">LEVOIT Humidifiers for Bedroom
                                    ...
                                    <div class="position-relative text-decoration-none product-card h-100">
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <a class="stretched-link text-decoration-none"
                                                   href="../../../apps/e-commerce/landing/product-details.html">
                                                    <h6 class="mb-2 lh-sm line-clamp-3">Rachael Ray Cucina Bakeware Set
                                    ...
                                    <div class="position-relative text-decoration-none product-card h-100">
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <a class="stretched-link text-decoration-none"
                                                   href="../../../apps/e-commerce/landing/product-details.html">
                                                    <h6 class="mb-2 lh-sm line-clamp-3">FURINNO Computer Writing Desk,
                                                        Walnut</h6>
                                                </a>
                                                <p class="fs--1"><span class="fa fa-star text-warning"></span><span
                                                        class="fa fa-star text-warning"></span><span
                                    ...
                                    <div class="position-relative text-decoration-none product-card h-100">
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div>
                                                ...
                                                <a class="stretched-link text-decoration-none"
                                                   href="../../../apps/e-commerce/landing/product-details.html">
                                                    <h6 class="mb-2 lh-sm line-clamp-3">Seagate Portable 2TB External
